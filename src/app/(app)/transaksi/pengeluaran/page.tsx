...
import { Plus, Search, TrendingDown, Download } from "lucide-react";
    ...
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-3 gap-4">
        <div className="card p-4 col-span-1">
          ...
          <p className="text-xs text-slate-400 mt-0.5">{mockExpenses.length} pengeluaran</p>
        </div>
              ...
              <div key={e.id} className="flex items-center gap-2">
                ...
                <div className="flex-1 h-1.5 bg-slate-100 rounded-full overflow-hidden">
                  <div
                    ...
                    style={{ width: `${(e.amount / totalExpense) * 100}%` }}
                  />
                </div>
